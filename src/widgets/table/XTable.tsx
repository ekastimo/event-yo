...
interface IHeaderProps extends WithStyles<typeof toolbarStyles> {
    numSelected: number
}

const EnhancedTableToolbarX = (props: IHeaderProps) => {
...
const EnhancedTableToolbar = withStyles(toolbarStyles)(EnhancedTableToolbarX);
